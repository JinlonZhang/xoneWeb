!function(){var global=this,objectPrototype=Object.prototype,toString=Object.prototype.toString,enumerables=!0,enumerablesTest={toString:1},i;"undefined"==typeof Das&&(global.Das={},global._=global.Das,global.Xone=global.Das),Das.global=global;for(i in enumerablesTest)enumerables=null;enumerables&&(enumerables=["hasOwnProperty","valueOf","isPrototypeOf","propertyIsEnumerable","toLocaleString","toString","constructor"]),Das.apply=function(e,t,r){if(r&&Das.apply(e,r),e&&t&&"object"==typeof t){var n,o,a;for(n in t)e[n]=t[n];if(enumerables)for(o=enumerables.length;o--;)a=enumerables[o],t.hasOwnProperty(a)&&(e[a]=t[a])}return e},Das.apply(Das,{emptyFn:function(){},create:function(){return function(){this.init.apply(this,arguments)}},error:function(e){throw e instanceof Error?e:new Error(e)},log:function(){},throttle:function(e,t){var r=null;return function(){var n=this,o=arguments;clearTimeout(r),r=setTimeout(function(){e.apply(n,o)},t)}},extend:function(e,t,r,n){var o=Object.prototype,a=e.prototype,i=Das.Object(a);return t.prototype=i,i.constructor=t,t.__super__=a,e!==Object&&e.constructor===o&&(a.constructor=e),r&&Das.apply(i,r),n&&Das.apply(t,n),t},Object:function(e){var t=Das.emptyFn;return t.prototype=e,new t}}),Das.apply(Das,{typeOf:function(e){if(null===e)return"null";var t=typeof e;if("undefined"===t||"string"===t||"number"===t||"boolean"===t)return t;var r=toString.call(e);switch(r){case"[object Array]":return"array";case"[object Date]":return"date";case"[object Boolean]":return"boolean";case"[object Number]":return"number";case"[object RegExp]":return"regexp"}return"function"===t?"function":"object"===t?void 0!==e.nodeType?3===e.nodeType?/\S/.test(e.nodeValue)?"textnode":"whitespace":"element":"object":void 0},isEmpty:function(e,t){return null===e||void 0===e||(t?!1:""===e)||Das.isArray(e)&&0===e.length},isArray:"isArray"in Array?Array.isArray:function(e){return"[object Array]"===toString.call(e)},isDate:function(e){return"[object Date]"===toString.call(e)},isObject:"[object Object]"===toString.call(null)?function(e){return null!==e&&void 0!==e&&"[object Object]"===toString.call(e)&&void 0===e.nodeType}:function(e){return"[object Object]"===toString.call(e)},isPrimitive:function(e){var t=typeof e;return"string"===t||"number"===t||"boolean"===t},isFunction:function(e){return"function"==typeof e},isNumber:function(e){return"number"==typeof e&&isFinite(e)},isNumeric:function(e){return!isNaN(parseFloat(e))&&isFinite(e)},isString:function(e){return"string"==typeof e},isBoolean:function(e){return"boolean"==typeof e},isElement:function(e){return e?void 0!==e.nodeType:!1},isTextNode:function(e){return e?"#text"===e.nodeName:!1},isDefined:function(e){return"undefined"!=typeof e},isIterable:function(e){return e&&"string"!=typeof e?void 0!==e.length:!1}}),Das.apply(Das,{each:function(e,t,r){if(!Das.isEmpty(e,!0)){(!Das.isIterable(e)||Das.isPrimitive(e))&&(e=[e]);for(var n=0,o=e.length;o>n;n++)if(t.call(r||e[n],e[n],n,e)===!1)return n}},namespace:function(){var a=arguments,o=null,i,j,d,rt;for(i=0;i<a.length;i++)for(d=a[i].split("."),rt=d[0],eval("if (typeof "+rt+' == "undefined"){'+rt+" = {};} o = "+rt+";"),j=1;j<d.length;++j)o[d[j]]=o[d[j]]||{},o=o[d[j]];return o}}),Das.ns=Das.namespace,Das.String={capitalize:function(e){return e.charAt(0).toUpperCase()+e.substr(1)},ellipsis:function(e,t){for(var r=new RegExp(/[^\x00-\xff]/),n=0,o=[],a=0;a<e.length;a++){var i=e.charAt(a);if(n+=r.test(i)?2:1,n>t)break;o.push(i)}return o.join("")==e?e:o.join("")+"..."},format:function(e){var t=arguments,r=[];r="array"==Das.typeOf(t[1])?[e].concat(t[1]):t;var n=new RegExp("%([1-"+r.length+"])","g");return String(e).replace(n,function(e,t){return r[t]})}},void 0===$.browser&&($.browser={}),$.browser.mozilla=/firefox/.test(navigator.userAgent.toLowerCase()),$.browser.webkit=/webkit/.test(navigator.userAgent.toLowerCase()),$.browser.opera=/opera/.test(navigator.userAgent.toLowerCase()),$.browser.msie=/msie/.test(navigator.userAgent.toLowerCase())}();
...
!function(e){e.ns("UI.AjaxUpload");var i=e.create();i.opt={},UI.AjaxUpload=i,e.extend(UI.Base,i,{init:function(e){var t=this;i.__super__.init.call(this,e),t.initMe(e)},initMe:function(e){var i=this;i.success=e.success,i.el.attr("target","ajax"),i.render(),i.initEvent()},render:function(){var e=this;e.buildIframe()},buildIframe:function(){var e=this,i=$('iframe[name="ajax"]');void 0==i.get(0)&&(i=$('<iframe class="hide" name="ajax"></iframe>'),$(document.body).append(i)),e.iframe=i},initEvent:function(){var e=this;e.iframe.bind("load",function(){var i=this.contentWindow.document.body;if(""!=$(i).text()){var t=JSON.parse($(i).text()||"{}");e.success&&e.success(t,e.el)}})}})}(Das);
!function(t){t.ns("UI");var o=t.create();o.opt={ns:"Base"},UI.Base=o,t.apply(o.prototype,{init:function(t){var o=this;o.el=t&&t.el;for(var e=o.constructor.opt,n=o.constructor.__super__;n;)e=$.extend({},n.constructor.opt,e),n=n.constructor.__super__;o.opt=$.extend(!0,{},e||{},t.opt||{},JSON.parse(o.el&&o.el.attr("opt")||"{}"),o.el&&o.el.data("opt")||{}),Das.log(o.opt)},setOpt:function(t){var o=this;o.opt=$.extend(!0,{},o.opt,t)},on:function(t,o){var e=this;t&&e.el.bind(t,function(t,e){o(t,e)})}})}(Das);
var TabEvent={SELECT:"TabSelect"},PlaceHolderEvent={FOCUS:"PlaceHolderFocus",BLUR:"PlaceHolderBlur"},PopupEvent={CHANGE:"PopupChange",SELECT:"PopupSelect",SHOW:"PopupShow",HIDE:"PopupHide",OK:"PopupOk",INITVALUE:"PopupInitValue",INITINPUT:"PopupInitInput",INITCITY:"PopupInitCity"},FormValidatorEvent={SUBMIT:"FormValidatorSubmit"},WinEvent={OK:"DialogOk",CANCEL:"DialogCancel",CLOSE:"DialogClose",SUBMIT:"DialogSubmit"};
!function(e){e.ns("UI");var t=e.create();UI.FormValidator=t,t.opt={formEntry:".u-f-entry"},e.apply(t,{valid:"allow",rules:{require:{regExp:/.+/,message:"%1不能为空！"},"int":{regExp:function(e){return t.empty.call(this,e,/^[-\+]?\d+$/)},message:"%1必须是整数！"},intPlus:{regExp:function(e){return t.empty.call(this,e,/^[0-9]*[1-9][0-9]*$/)},message:"%1必须是正整数！"},"float":{regExp:function(e){return t.empty.call(this,e,/^[-\+]?\d+(\.\d+)?$/)},message:"%1必须是浮点数！"},floatPlus:{regExp:function(e){return t.empty.call(this,e,/^\d+(\.\d+)?$/)},message:"%1必须是正浮点数！"},email:{regExp:function(e){return t.empty.call(this,e,/^\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$/)},message:"%1格式不正确！"},phone:{regExp:function(e){return t.empty.call(this,e,/^1[3|4|5|8][0-9]\d{8}$/)},message:"%1格式不正确！"},min:{regExp:function(e){return this.size>=e},message:"%1至少选择 %2 个！"},length:{regExp:function(e,t){return this.val().length>=e&&this.val().length<=t},message:"%1长度必须 %2 到 %3 位！"},maxLength:{regExp:function(e){return this.val().length<=e},message:"%1长度必须小于 %2 位！"},confirm:{regExp:function(e){return this.val()==$("#"+e).val()},message:"%1不一致！"},username:{regExp:function(e){return-1==this.val().indexOf("@")?t.rules.phone.regExp.call(this,e):t.rules.email.regExp.call(this,e)},message:"%1不合法！"},nickname:{regExp:function(e){return t.empty.call(this,e,/^[a-zA-Z0-9_]+$/)},message:"%1不合法！只能是英文字符、数字、下划线"},least:{regExp:function(e){return!(""==this.val()&&""==$("#"+e).val())},message:"%1至少填写一项！"},size:{regExp:function(e,t){return parseInt(this.val())>=e&&parseInt(this.val())<=t},message:"%1必须是 %2 到 %3！"},less:{regExp:function(e){return parseInt(this.val())<parseInt($("#"+e).val())},message:"%1必须是小于%2 "},ip:{regExp:function(e){return t.empty.call(this,e,/^((1?\d?\d|(2([0-4]\d|5[0-5]))).){3}(1?\d?\d|(2([0-4]\d|5[0-5])))$/)},message:"%1格式不正确！"}},elementMap:{INPUT:{text:function(e,a){return t.validateDom(e,a)},password:function(e,a){return t.validateDom(e,a)},radio:function(e,a){for(var r={value:"",size:0},n=e.data("validator"),i=0;i<n.length;i++){var s=n[i];s.checked&&(r.size++,r.value+=s.value+",")}return t.validateDom(e,a,r)},checkbox:function(e,a){return t.elementMap.INPUT.radio(e,a)}},SELECT:{normal:function(e,a){return t.validateDom(e,a)}},TEXTAREA:{normal:function(e,a){return t.validateDom(e,a)}}},validateDom:function(t,a,r){var n=this,i=r?r.value+"":t.val(),s={code:0,obj:{dom:t,text:a.message}};for(var l in a){var u=a[l],o="array"==e.typeOf(u)?u:[u];if("undefined"!=typeof n.rules[l]&&(s.code="function"==e.typeOf(n.rules[l].regExp)?n.rules[l].regExp.apply(r?r:t,o)?0:-1:n.rules[l].regExp.test($.trim(i))?0:-1,s.obj.text="object"==e.typeOf(a.title)?e.String.format(n.rules[l].message,a.title[l]):e.String.format(n.rules[l].message,a.title),-1==s.code))return s}return s},addRule:function(e,t){this.rules[e]=t},empty:function(e,t){return""==this.val()?!0:t.test(this.val())}}),e.extend(UI.Base,t,{result:{code:0,list:[]},messageDom:[],init:function(e){var a=this;t.__super__.init.call(this,e),a.initMe(e)},initMe:function(){var e=this;e.initHTML(),e.initEvent()},initHTML:function(){var e=this;e.id=e.el.attr("id")||e.el.attr("name")||"noId"},initEvent:function(){var e=this;e.on(FormValidatorEvent.SUBMIT,function(a,r){e.elements=$("input[#],select[#],textarea[#]".replace(/#/g,t.valid),e.el),e.reset(),e.validator(r)})},reset:function(){var e=this;e.result.code=0,e.result.list=[];for(var t=e.messageDom.length;t--;)e.messageDom[t].remove()},validator:function(e){{var a=this;a.elements.size()}if(a.elements.each(function(){var e=$(this);if("INPUT"==this.tagName&&("radio"==this.type||"checkbox"==this.type)){var t=this.name,a=[],r=$("input[name='"+t+"']");r.each(function(){a.push({checked:this.checked,value:this.value})}),e.data("validator",a)}}),a.elements.each(function(){var e=$(this),t="",r={};if(!e.attr("disabled")){switch(this.tagName){case"INPUT":t=this.type||"text";break;case"SELECT":t=this.multiple?"multiple":"normal";break;case"TEXTAREA":t="normal"}r=a.validateEach(e,this.tagName,t),-1==r.code&&(a.result.code=-1,a.result.list.push(r.obj))}}),-1==a.result.code){for(var r=0;r<a.result.list.length;r++){var n=a.result.list[r],i=$("<p class='ib ch-fv'><i class='fa fa-exclamation-circle fa-l'></i></p>"),s=n.dom.parents(t.opt.formEntry);i.append(n.text),a.messageDom.push(i),s.append(i)}$('[type="submit"]',a.el).removeAttr("disabled")}else e&&e()},validateEach:function(e,a,r){var n={};try{n=JSON.parse(e.attr("allow"))}catch(i){alert(e.attr("allow")+"语法错误！\n\nJSON字符串的key和value(如果value是字符串)必须用双引号引起来。")}return t.elementMap[a][r](e,n)}})}(Das);
!function(){_.ns("UI");var t=_.create();t.opt={cls:"u-msg",type:"ok",text:"保存成功"},UI.Message=t,_.extend(UI.Base,t,{type:{ok:'<i class="fa fa-check-circle fa-orange fa-18"></i>'},init:function(e){var i=this;t.__super__.init.call(this,e),i.initHTML()},initHTML:function(){var t=this;t.buildEl()},buildEl:function(){var t=this,e=$(".u-msg");e.get(0)?t.el=e:(t.el=$("<div></div>"),t.el.addClass(t.opt.cls),$(document.body).append(t.el)),t.hide()},setText:function(t){var e=this;e.el.html(e.type[e.opt.type]+(t||e.opt.text))},show:function(t){var e=this,i=t.opt,n=t.param,s=i.timeout||1e3;e.el.show(),window.setTimeout(function(){e.hide(),i.fn&&i.fn(n)},s)},hide:function(){var t=this;t.el.hide()}})}();
!function(i){i.ns("UI");var t=i.create();t.opt={trigger:"click",pos:"left"},UI.Popup=t,i.extend(UI.Base,t,{init:function(i){var o=this;t.__super__.init.call(this,i),o.initMe(i)},initMe:function(){var i=this;i.docMouseUpFlag=!1,i.isShow=!1,i.trigger=i.el.find(".j-pop-trigger"),i.box=i.el.find(".j-pop-box"),void 0==i.trigger.get(0)&&(i.trigger=i.el),i.initHTML(),i.initEvent()},initHTML:function(){var i=this;i.box.css("top",i.trigger.outerHeight(!0)),"right"==i.opt.pos&&i.box.css({right:0,left:"auto"})},initEvent:function(){var i=this;"click"==i.opt.trigger&&i.trigger.bind("click",function(){i.isShow?i.hide():i.show()}),"hover"==i.opt.trigger&&i.el.hover(function(){i.show()},function(){i.hide()})},show:function(){var i=this;i.box.show(),i.isShow=!0,"click"==i.opt.trigger&&(i.docMouseUpFlag||$(document.body).mouseup($.proxy(i.docMouseUp,i)),i.docMouseUpFlag=!0)},hide:function(){var i=this;i.box.hide(),i.isShow=!1},docMouseUp:function(i){var t=this;t.isShow&&($.contains(t.el.get(0),i.target)||t.hide())}})}(Das);
!function(t){t.ns("UI");var i=t.create();UI.PopupSelect=i,t.extend(UI.Popup,i,{init:function(t){i.__super__.init.call(this,t)},initMe:function(t){var n=this;n.inputs=n.opt.inputs,n.inputsObj={},n.textDom=n.el.find(".j-pop-txt"),n.form=n.el.parents(".j-form"),i.__super__.initMe.call(this,t)},initHTML:function(){var t=this;i.__super__.initHTML.call(this),t.buildInput()},initEvent:function(){var t=this;i.__super__.initEvent.call(this),t.initEventMe()},initEventMe:function(){var t=this;t.box.find("li").bind("click",function(){t.itemClick($(this))})},buildInput:function(){for(var t=this,i=t.inputs.length;i--;){var n=t.inputs[i],e=$("<input type='text' class='hide J_Popup__input' size='2'/>");e.attr({name:n.name,allow:JSON.stringify(n.allow)||"{}"}),t.inputsObj[n.mapper]=e,t.el.append(e),e.bind(PopupEvent.INITVALUE,function(i,n){t.initValue(n.val)})}},initValue:function(t){var i=this,t=t||i.el.attr("val");i.box.find("li").each(function(){var n=$(this),e=n.attr("v")||n.text();e==t?(n.addClass("now"),i.valueToInput(n.data("json"))):n.removeClass("now")})},itemClick:function(t){var i=this;i.box.find("li").removeClass("now"),t.addClass("now"),i.change({text:t.text(),val:t.attr("v")})},change:function(t){var i=this;i.valueToInput(t),i.el.trigger(PopupEvent.CHANGE,t),i.hide()},valueToInput:function(t){var i=this;i.textDom&&i.textDom.text(t.text);for(var n in t)i.inputsObj[n]&&i.inputsObj[n].val(t[n])},clear:function(){var t=this;for(var i in t.inputsObj)t.inputsObj[i].val("");t.box.find("li").removeClass("now"),t.textDom.text(t.opt.defaultText||"请选择")}})}(Das);
!function(t){t.ns("UI");var i=Das.create();UI.WaterFall=i,t.extend(UI.Base,i,{init:function(t){var n=this;i.__super__.init(t),n.num=0,n.cols=[],n.build(),n.initEvent()},initEvent:function(){},build:function(t){var i=this,n=i.el.width(),e=t||$(".j-panel"),h=e.width();i.num=parseInt(n/h);for(var s=0;s<i.num;s++)i.cols[s]={index:s,height:0,count:0};e.each(function(){var t=$(this),n=i.getMin(),e=i.cols[n.index];t.css({top:e.height,left:(h+20)*n.index}),e.height+=t.height()+20,e.count++}),i.el.css("height",i.getMax().height)},getMin:function(){for(var t=this,i=t.cols[0],n=1;n<t.cols.length;n++)t.cols[n].height<i.height&&(i=t.cols[n]);return i},getMax:function(){for(var t=this,i=t.cols[0],n=1;n<t.cols.length;n++)t.cols[n].height>i.height&&(i=t.cols[n]);return i},resize:function(){var t=this;t.build()}})}(Das);
!function(i){i.ns("UI.Window");var n=i.create();n.opt={title:"对话框",h:260,w:500,showHead:0,showClose:1,showMask:1,showBtn:0,cls:""},UI.Window=n,i.extend(UI.Base,n,{init:function(i){var t=this;n.__super__.init.call(this,i),t.initMe(i)},initMe:function(){var i=this;i.mid="win_mask",i.wid="win_win",i.render(),i.initEvent()},render:function(){var i=this;i.buildEl(),i.buildContent(),1==i.opt.showMask?i.buildMask():null,1==i.opt.showClose?i.buildClose():null,1==i.opt.showHead?i.buildHead():null},buildEl:function(){var i=this,n=['<div class="u-win" id="'+i.wid+'">',"</div>"];i.el=$(n.join("")),i.el.css({height:i.opt.h,width:i.opt.w}).hide(),$(document.body).append(i.el)},buildClose:function(){var i=this,n=$('<a class="fa fa-times u-win-close j-Win-close" href="javascript://"></a>');i.closeBtn=n,i.closeBtn.bind("click",function(){i.close()}),i.el.append(n)},buildHead:function(){var i=this,n=['<div class="u-win-head">',"</div>"];i.headEl=$(n.join("")),i.el.append(i.headEl),i.setTitle()},buildContent:function(){var i=this;i.content=$('<div class="u-win-cont j-win-cont"></div>'),i.el.append(i.content)},initEvent:function(){var i=this;$(document).bind("keydown",function(n){27==n.keyCode&&i.close()})},setTitle:function(i){var n=this,t=i||n.opt.title;n.headEl.html(t)},setContent:function(i){var n=this;n.content.empty().append(i)},setPosition:function(){var i=this,n=($(window).height()-i.el.height())/2;i.el.css({top:n+$(document).scrollTop(),"margin-left":-i.opt.w/2})},open:function(i){var n=this;i&&n.setContent(i),n.setPosition(),n.mask.show(),n.el.show()},close:function(){var i=this;i.mask.hide(),i.el.hide(),i.el.trigger(WinEvent.CLOSE)},buildMask:function(){var i=this;i.mask=$("#"+i.mid),void 0==i.mask.get(0)&&(i.mask=$("<div class='u-win-mask'></div>"),i.mask.attr("id",i.mid).hide(),$(document.body).append(i.mask))}})}(Das);
!function(t){t.ns("app.bind"),t.apply(app.bind,{init:function(){var t=this;t.form=$(".j-form"),t.uploadForm=$(".j-uploadForm"),t.action=$(".j-action"),t.pop=$(".j-pop"),t.delete=$(".j-del"),t.initHTML(),t.initEvent()},initHTML:function(){var t=this;t.delete.data("opt",{type:"delete",confirm:"确定删除？",text:"删除成功！"}),t.action.each(function(){t.initDomOpt($(this))}),t.form.each(function(){t.initDomOpt($(this)),new UI.FormValidator({el:$(this)})}),t.uploadForm.each(function(){t.initDomOpt($(this)),new UI.FormValidator({el:$(this)})}),t.pop.each(function(){new UI.Popup({el:$(this)})}),t.uploadForm.each(function(){new UI.AjaxUpload({el:$(this),success:function(t,n){app.common.ajaxCallBack(t,n)}})})},initDomOpt:function(t){var n={fn:function(){window.location.reload(!0)}},i=t,o=i.data("opt")||{},a=i.attr("opt")||"{}";i.data("opt",$.extend(!0,{},n,o,JSON.parse(a)))},initEvent:function(){var t=this;t.form.submit(function(){return t.formSubmit($(this)),!1}),t.form.each(function(){var n=$(this);n.find(".j-submit").click(function(){t.formSubmit(n)})}),t.action.bind("click",function(){return t.actionClick($(this)),!1})},formSubmit:function(t){t.trigger(FormValidatorEvent.SUBMIT,function(){$.ajax({url:t.attr("action"),type:t.attr("method"),dataType:"json",data:t.serialize(),success:function(n){app.common.ajaxCallBack(n,t)}})})},actionClick:function(t){var n=t.attr("_url"),i=t.data("opt"),o=function(){$.ajax({type:i.type,url:n,dataType:"json",success:function(n){app.common.ajaxCallBack(n,t)}})};i.confirm?window.confirm(i.confirm)&&o():o()}})}(Das);
!function(t){t.ns("app.common"),t.apply(app.common,{init:function(){var t=this;t.initHTML(),t.initEvent()},initHTML:function(){var t=this;t.Message=new UI.Message({})},initEvent:function(){},ajaxCallBack:function(t,e){var n=this,a=e.data("opt");if(0==t.code)a.hideText&&1==a.hideText?a.fn&&a.fn(t):(n.Message.setText(a.text),n.Message.show({param:t,opt:a}));else{var i=$("#msg");i.get(0)?i.text(t.msg).show():alert(t.msg)}}})}(Das);